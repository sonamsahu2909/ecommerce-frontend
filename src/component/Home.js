            ...
            <div className="col-lg-8">
                <div id="header-carousel" className="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    <ol className="carousel-indicators">
                        <li data-target="#header-carousel" data-slide-href="0" className="active"></li>
                        <li data-target="#header-carousel" data-slide-href="1"></li>
                        <li data-target="#header-carousel" data-slide-href="2"></li>
                    </ol>
                    <div className="carousel-inner">
                        <div className="carousel-item position-relative active"style={{height: '460px'}}>
                        ...
                        <div className="carousel-item position-relative" style={{height: '460px'}}>
                            <img className="position-absolute w-100 h-100" src="/img/carousel-2.jpg" alt='' style= {{objectFit: 'cover'}} />
                            <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div className="p-3" style={{maxWidth:'700px'}}>
                        ...
                        <div className="carousel-item position-relative" style={{height: '460px'}}>
                            <img className="position-absolute w-100 h-100" src="img/carousel-3.jpg" alt='' style={{objectFit: 'cover'}} />
                            <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div className="p-3" style={{maxWidth:'700px'}}>
