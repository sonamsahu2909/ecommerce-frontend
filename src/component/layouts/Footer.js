                ...
                <div className="row">
                    ...
                    <div className="col-md-4 mb-5">
                        ...
                        <div className="d-flex">
                            <Link className="btn btn-primary btn-square mr-2" href="#"><i className="fab fa-twitter"></i></Link>
                            <Link className="btn btn-primary btn-square mr-2" href="#"><i className="fab fa-facebook-f"></i></Link>
                            <Link className="btn btn-primary btn-square mr-2" href="#"><i className="fab fa-linkedin-in"></i></Link>
                            <Link className="btn btn-primary btn-square" href="#"><i className="fab fa-instagram"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div className="row border-top mx-xl-5 py-4" style={{borderBlockColor: 'rgba(256, 256, 256, .1) !important'}}>
            <div className="col-md-6 px-xl-0">
                <p className="mb-md-0 text-center text-md-left text-secondary">
                    &copy; <Link className="text-primary" href="#">Domain</Link>. All Rights Reserved. Designed
                    by
                    <Link className="text-primary" href="https://htmlcodex.com">HTML Codex</Link>
                </p>
            </div>
